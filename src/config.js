...
export const CHARACTERS = {
    ...
    ISHIGORI: {
        ...
        skills: {
            ...
            domain: { name: 'Time Cell Moon Palace', cost: 100, sureHitType: 'dps' },
            maximum: { name: 'Maximum Output', cost: 150, damage: 550, type: 'beam' },
        },
        domainBg: 'ishigori_domain',
    },
    KUROROSHI: {
        id: 'kuroroshi',
        name: 'Kuroroshi',
        ...
        skills: {
            ...
            domain: { name: 'Deadly Swarm', cost: 100, sureHitType: 'dps' },
            maximum: { name: 'Plague of Decay', cost: 150, damage: 400, type: 'poison' },
        },
        domainBg: 'kuroroshi_domain',
    },
};
