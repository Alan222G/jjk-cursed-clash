...
export const CHARACTERS = {
    ...
    HANAMI: {
        ...
        skills: {
            skill1: { name: 'Wood Buds', cost: 30, damage: 40, type: 'drain' },
            skill2: { name: 'Emerging Roots', cost: 45, damage: 60, type: 'knockup' },
            domain: { name: 'Daichi no Megumi', cost: 100, sureHitType: 'lifesteal' },
            maximum: { name: 'Solar Beam', cost: 150, damage: 600, type: 'beam' },
        },
    ...
    CHOSO: {
        ...
        stats: {
            ...
            weight: 95,
            jumpForce: -620,
            domainDuration: 0, // No domain, has awakening
            domainPhase1: 0,
        },
        skills: {
            skill1: { name: 'Piercing Blood', cost: 25, damage: 70, type: 'sniper' },
            skill2: { name: 'Supernova', cost: 50, damage: 15 * 6, type: 'aoe' },
            domain: { name: 'Awakening', cost: 80, sureHitType: 'poison' },
            maximum: { name: 'Wing King', cost: 150, damage: 500, type: 'summon' },
        },
        domainBg: null,
    },
};
