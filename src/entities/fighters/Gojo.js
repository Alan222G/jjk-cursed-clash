...
export default class Gojo extends Fighter {
    ...
    fireRed() {
        ...
        this.castWithAudio('sfx_red', () => {
            ...
            const proj = new Projectile(this.scene, this.sprite.x + 40 * this.facing, this.sprite.y - 70, {
                owner: this,
    ...
    firePurple() {
        ...
        this.castWithAudio('sfx_purple', () => {
            ...
            const proj = new Projectile(this.scene, this.sprite.x + 60 * this.facing, this.sprite.y - 70, {
                owner: this,
                damage: Math.floor(skill.damage * this.power),
                knockbackX: 1200,
                knockbackY: -400,
